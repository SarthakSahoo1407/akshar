...
var Akshar = (_a) => {
  var _b = _a, {
    onChangeText,
    value,
    renderComponent = (props) => /* @__PURE__ */ import_react.default.createElement("input", __spreadValues({}, props)),
    lang = "hi",
    maxOptions = 5,
    offsetY = 0,
    offsetX = 0,
  ...
  const calculateCaret = (0, import_react.useCallback)(() => {
    if (!inputRef.current) return;
    const el = inputRef.current;
    if (document.activeElement !== el || typeof el.selectionEnd !== "number") return;
    const coords = (0, import_textarea_caret.default)(el, el.selectionEnd);
    let lineHeight = 20;
    try {
